...
func TestClientSecretHasherHash(t *testing.T) {
	...
	require.NoError(t, clientSecretHasher{}.Compare(t.Context(), hash, []byte(value)))
}
...
func TestClientSecretHasherAcceptsModelEncoding(t *testing.T) {
	...
	require.NoError(t, clientSecretHasher{}.Compare(t.Context(), secret.EncodedHash(), []byte(value)))
}
